...
git log --merges --oneline | wc -l          # -> 41
...
**Total : 41 commits de merge.** Sur ces 41, **40 sont des PR de fonctionnalité ou de
...
| 2026-W30 | 20/07 → 26/07 | 6 | 41 | Finalisation avant soutenance : correctif de l'issue métriques (#97), corrections issues de l'audit RNCP E3-E5 (#98), fiabilisation de l'ordre de démarrage PostgreSQL en déploiement (#99), lifting UI et matrice de confusion (#100), rapport d'entraînement servi en prod (#101), plus une intégration intermédiaire de `develop` |
...
xychart-beta
    ...
    x-axis ["W26", "W27", "W28", "W29", "W30"]
    y-axis "PR fusionnées (cumul)" 0 --> 41
    line [3, 23, 23, 35, 41]
```
...
- **Pic de production (W27, 20 PR).** La semaine la plus dense du projet, et de loin :
  elle concentre à elle seule **49 % des PR fusionnées** (20 sur 41). Le socle applicatif
...
- **Finalisation (W30, 6 PR).** Dernière semaine avant la soutenance, orientée fiabilisation
  et polissage : correctif de l'issue métriques (#97), corrections issues de l'audit RNCP
  E3-E5 (#98), ordre de démarrage PostgreSQL en déploiement (#99), refonte visuelle et
  matrice de confusion (#100), et mise en production du rapport d'entraînement (#101).
